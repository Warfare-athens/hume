...
const CartDrawer = () => {
  ...
  const giftUnlocked = eligible50mlCount >= giftGoal;
  ...
  const generateOrderMessage = () => {
    ...
    const giftLine = giftUnlocked
      ? "\n\nPromo: Free 50ml gift unlocked. Please include my selected gift in this order."
      : "";

    return `Hello HUME Perfumes,\n\nI would like to place an order:\n\n${orderLines}\n\nSubtotal: ${formatINR(subtotal)}\nDelivery: ${shippingFee === 0 ? "FREE" : formatINR(shippingFee)}\nGrand Total: ${formatINR(grandTotal)}${giftLine}\n\nPlease let me know how to proceed with the payment.`;
  };
